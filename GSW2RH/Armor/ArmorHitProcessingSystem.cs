    ...
    public class ArmorHitProcessingSystem : IEcsRunSystem
    {
        ...
        public void Run()
        {
            foreach (int i in _peds)
            {
                ...
                Debug.DrawWireBoxDebug(position, ped.Orientation, new Vector3(gswPed.Armor / maxArmor, 0.1f, 0.1f), Color.MediumBlue);
#endif
            }
            ...
            foreach (int i in _damagedPeds)
            {
                ...
                {
#if DEBUG
                    Game.Console.Print("Ped " + ped.Model.Name + " doesn't have armor");
#endif
                ...
                {
#if DEBUG
                    Game.Console.Print("This body part is not protected by armor");
#endif
                    ped.Armor = gswPed.Armor;
                    continue;
                }
                ...
                {
#if DEBUG
                    Game.Console.Print("Armor was destroyed");
#endif
                    ped.Armor = gswPed.Armor;
                    continue;
                }
                ...
                {
#if DEBUG
                    Game.Console.Print("Armor was not penetrated, when chance was " + chanceToPenetrate);
#endif
                    _ecsWorld.RemoveComponent<DamagedByWeaponComponent>(pedEntity);
                    ped.Armor = gswPed.Armor;
                    continue;
...
#if DEBUG
                Game.Console.Print("Armor was penetrated, when chance was " + chanceToPenetrate);
#endif
                ped.Armor = gswPed.Armor;
            }
        }
